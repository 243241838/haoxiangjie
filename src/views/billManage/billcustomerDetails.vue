<template>
    <div class="app-container calendar-list-container">
        <el-tabs v-model="tabsName" type="card" @tab-click="handleClick">
            <el-tab-pane label="基本信息" name="first" v-if="financePowerControl!==5">
            ...
            <el-tab-pane label="通讯录信息" name="third" v-if="financePowerControl!==5">
                <div class="filter-container">
                    <h3>通话记录明细</h3>
            ...
            <el-tab-pane label="征信信息" name="fourth" v-if="financePowerControl!==5">
                ...
                <div v-else>
                    <el-table :data="listZhimaWatchinfoPo" style="width: 100%" height="120">
                        <el-table-column align="center" label="行业关注名单">
                            <template scope="scope">
                            </template>
                        </el-table-column>
            ...
            <el-tab-pane label="设备信息" name="fifth" v-loading="loading" v-if="financePowerControl!==5">
...
export default {
    ...
    created() {
        ...
        this.financePowerControl === 5 ? this.tabsName = 'second' : "";
        this.handleClick();
    },
    methods: {
        changeQuery(url) {
