  ...
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-table :data="dataList" v-loading="listLoading" border fit highlight-current-row style="width: 100%" @current-change="handleCurrentChange">
        ...
        <el-table-column align="center" label="滞纳金（元）">
          <template scope="scope">
            <span>{{scope.row.overdueFine}}</span>
          </template>
        </el-table-column>
...
export default {
  data() {
    return {
      ...
      pickTimeStart: "",
      pickTimeEnd: "",
      listQuery: {  params: { url: 'lendOrder/listExceptionalRepaymentOrder',size: 10, page: 1, orderNo: '', endDate: "", startDate: "", mobile: "", realName: "", userId: "" } },
