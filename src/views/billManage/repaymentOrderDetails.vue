    ...
    <el-tabs v-model="tabsName" type="card" @tab-click="handleClick">
      <el-tab-pane label="订单信息" name="first">
        ...
        <div class="filter-container">
          ...
          <el-row>
            <el-col :span="10" :offset="1">
              <el-form label-width="110px" class="credit-aplly-form" v-if="listRepaymentPo">
...
export default {
  ...
  methods: {
    ...
    //获取银行卡信息
    getbankcardList() {
      this.bankCardQuery.params.orderNo = this.$route.query.orderNo;
