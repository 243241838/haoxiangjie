...
export default {
  data() {
    return {
      ...
      //handleExceptionalQuery: { params: { url: 'lendOrder/handleExceptional', orderNo: '' } },
      ...
      productPo: null,
      //listRepaymentPo: [{ realLeadTime: '', actualRepayTime: '', actualRepayAmount: '', principal: '', fee: '', serviceCharge: '', queryCharge: '', transferCharge: '' }],
      //
      listRepaymentPo: [{}],
      //listPaymentCapitalPo: [{ amount: '', notifyTime: '', thirdPartyCapitalNo: '' }],
  ...
  methods: {
    ...
    // handleExceptional() {
    //   this.handleExceptionalQuery.params.orderNo = this.orderNo;
    //   config(this.handleExceptionalQuery.params).then(response => {
