                ...
                <el-collapse v-model="collapse">
                    ...
                    <el-collapse-item title="身份信息" name="2">
                        ...
                        <div v-if="customerDetail.commonUserPo">
                            ...
                            <el-input v-model="customerDetail.commonUserPo.idenAddress" class="www-el-label-input big" readonly>
                                <template slot="prepend">
                    ...
                    <el-collapse-item title="个人信息" name="3">
                        <div v-if="customerDetail.userExtendsPo">
                            ...
                            <el-input v-model="customerDetail.userExtendsPo.userAreaIdName" class="www-el-label-input big" readonly>
                                <template slot="prepend">
                        ...
                        <div v-if="customerDetail.userExtendsPo" style="margin-top:20px;">
                            ...
                            <el-input v-model="customerDetail.userExtendsPo.companyAreaIdName" class="www-el-label-input big" readonly>
                                <template slot="prepend">
...
export default {
    ...
    created() {
        this.getBaseInfo('customerDetail', data => {
        ...
        getCreditList() {
            config(this.creditQuery.params).then(response => {
                if (response.respCode === '000000') {
                    ...
                    if (this.listZhimaWatchinfoPo == null) {
                    }
                }
            }).catch(err => {
            })
